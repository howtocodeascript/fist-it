-- HΔ HOWTO HUB - FISH IT! | POP-UP ADDED (Click Logo to Toggle)
-- Original script enhanced with HΔ splash & clickable logo (no Insert)
...
NewToggle("Auto Fish Ultra", function(v)
    getgenv().AutoFish = v
    Notify(v and "Auto Fish: ENABLED" or "Auto Fish: DISABLED")
    if v then
        spawn(function()
